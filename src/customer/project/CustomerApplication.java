...
public class CustomerApplication {
	...
	public static void main(String[] args) {	
		...
		public static Customer findCustomer(int customerID) {
			findCustomer = int customerID(10050);
		}
		...
		if (customerList == null) {
			...
			findCustomer.showPriceBonus = (10000);
		}
	...
	public static void showPriceBonus(Customer customer, int price) {
		 ...
		 */
		int cost = customer.calcPrice;
		System.out.println("======해당 고객의 할인율과 보너스 포인트 계산======");
		System.out.println(customer + "님의 지불금액: " + cost + "원");
		System.out.println(customer + "님의 현재 보너스 포인트: " + bonusPoint + "점");
	}
}
